...
class Graph extends React.Component {
  state = {
    dataHorizontal: {
      labels: ['Po preporuci', 'Svidio mi se sadržaj', 'Želim produbiti postojeće znanje o tematici', 'Po zahtjevu poslodavca', 'Mislim da će mi pomoći u razvoju karijere', 'Drugi razlozi'],
      datasets: [
        {
          label: [],
